...
function $output(arg,argValue,$$cs,ch_lvl,policy) {
...
function chkpassword(pwd) {
    var i, $tmp1;
    $Γ['global']['chkpassword']['$tmp1'] = $Γ['global']['chkpassword']['i'] = 0;
    i = 0;
    $scope($Γ['global']['chkpassword'], 'i', true)['i'] = $Λ[$Λ.length - 1].l;
    $tmp1 = i < 1;
    $Γ['global']['chkpassword']['$tmp1'] = sec_lvl('i', null, true, $Γ['global']['chkpassword']) >= $Λ[$Λ.length - 1].l ? sec_lvl('i', null, true, $Γ['global']['chkpassword']) : $Λ[$Λ.length - 1].l;
    ...
    while ($tmp1) {
        var $tmp2, $tmp3, $tmp1;
        $Γ['global']['chkpassword']['$tmp1'] = $Γ['global']['chkpassword']['$tmp3'] = $Γ['global']['chkpassword']['$tmp2'] = 0;
        $tmp2 = $output('pwd',pwd,$Γ['global']['chkpassword'],0,'suppress');
        $tmp3 = i++;
        $Γ['global']['chkpassword']['$tmp3'] = sec_lvl('i', null, false, $Γ['global']['chkpassword']);
