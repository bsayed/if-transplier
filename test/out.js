...
if ($tmp19) {
    ...
    $tmp15.base64Encode = function () {
        ...
        $Γ['global']['$tmp15']['base64Encode']['$tmp272'] = sec_lvl('Buffer', null, false, $Γ['global']['$tmp15']['base64Encode']);
...
if ($tmp22) {
    ...
    $tmp15.base64Decode = function () {
        ...
        $Γ['global']['$tmp15']['base64Decode']['$tmp275'] = sec_lvl('Buffer', null, false, $Γ['global']['$tmp15']['base64Decode']);
...
$tmp25 = console.log;
$Γ['global']['$tmp25'] = sec_lvl('console', 'log', false, $Γ['global']);
...
print = print || $tmp25;
$Γ['global']['print'] = $lub(sec_lvl('print', null, true, $Γ['global']), sec_lvl('$tmp25', null, true, $Γ['global']));
